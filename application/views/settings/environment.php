     	 ...
     	 <form class="col s12" method="post" action="<?php echo SITE_URL?>settings/environment/setEnvironment" name="<?php echo $moduleForm?>" id="<?php echo $moduleForm?>">
            ...
            <div class='row'>
              <div class='input-field col s12'>
                <input disabled type="text" name='txtKeyDescription' id='txtKeyDescription' readonly="true" data-set="key_description" value="" />
                <label for='txtKeyDescription'>Enter Key Description *</label>
              </div>
            </div>

			<div class='row'>
              <div class='input-field col s12'>
				<input type="text" name='txtValueDescription' id='txtValueDescription' data-set="value_description_oringial" value="" readonly="true" />
                <label for='txtValueDescription'>Enter Value Description *</label>
              </div>
            </div>

			<div class="jsonEnv"></div>
