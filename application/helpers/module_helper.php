...
class Module{
	...
	/***************************************************************************/
	/* Purpose	: get module details by slug
	/* Inputs 	: $pStrModuleSlug	:: Module slug.
	/* Returns	: module array details.
	/***************************************************************************/
	public function getModulesBySlug($pStrModuleSlug = ''){
		/* Variable initialization */
		$strReturnArr	= array();
		
		/* if slug is not pass then do needful */
		if($pStrModuleSlug == ''){
			/* return empty array */
			return strReturnArr;
		}
		...
		/* Variable initialization */
		$strWhereArr	= array('company_code'=>$this->_intCompanyCode,'module_url'=>$pStrModuleSlug);
