...
function showToast(pStrMessage){
	M.toast({html: pStrMessage,displayLength:intTimeToShowMessage});
}
...
/**************************************************************************
 * Purpose	:	To check What is string or array or obect or other else.
 * Inputs	:	object.
 * Return	:	sting.
...
/**************************************************************************
 * Purpose	:	To check What is string json or not.
 * Inputs	:	String.
 * Return	:	Boolean.
 * Ref. 	:	https://stackoverflow.com/questions/9804777/how-to-test-if-a-string-is-json-or-not
 * Created by:	Vipin Kumar R. Jaiswar
****************************************************************************/
function isJson(str) {
    try {
